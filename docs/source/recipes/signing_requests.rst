...
Typically, you'll deploy Reactor on a running EC2 instance on AWS. You can
...
tell Reactor to authenticate itself using that user. First, create an AWS
profile in the machine where you'd like to run Reactor for the user with
permissions.
